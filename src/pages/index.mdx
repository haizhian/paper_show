...
import overviewFigure from "../assets/Figure3_overview.png";
...
<Header
  title={
    <div class="flex items-center justify-center gap-3">
      ...
      <img src={import.meta.env.BASE_URL + "xidian_logo.svg"} alt="University logo" class="h-12 inline-block" />
    </div>
  }  
  authors={[
    {
...
<Figure>
  <Image slot="figure" source={overviewFigure} altText="Overview of our CheXPO method" />
