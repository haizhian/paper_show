...
title: CheXPO: Preference Optimization for Chest X-ray VLMs
with Counterfactual Rationale
favicon: favicon.svg
...
import overviewFigure from "../assets/Figure3_overview.pdf";
...
<Header
  ...
  title={
    <div class="flex items-center justify-center gap-3">
      ...
      <img src="/xidian_logo.svg" alt="University logo" class="h-12 inline-block" />
    </div>
  }  
  authors={[
    {
      ...
      institution: "The Key Laboratory of Smart Human-Computer Interaction and Wearable Technology of Shaanxi Province, Xidian University, Xi’an, China", 
    },
  ]}
  conference="ACM MM" 
  ...
  links={[
    {
      name: "Paper",
      url: "https://arxiv.org/pdf/2507.06959",
      icon: "ri:file-pdf-2-line",
    },
    {
      name: "Code",
      url: "https://github.com/ResearchGroup-MedVLLM/CheX-Phi35V",
      icon: "ri:github-line",
    },
    {
      name: "arXiv",
...
<Figure>
  <PDF slot="figure" source={overviewFigure} />
  <span slot="caption">Overview of our CheXPO method for chest X-ray VLM preference optimization.</span>
</Figure>
